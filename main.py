...
def getHeuristic(board, move, player):
  ...
  if col + 1 < 10 and \
     (board[row][col + 1] == player or \
     (row + 1 < 10 and board[row + 1][col + 1] == player) or \
     (row - 1 >= 0 and board[row - 1][col + 1] == player)):
    if col + 2 < 10 and \
       (board[row][col + 2] == player or \
       (row + 2 < 10  and board[row + 2][col + 2] == player) or \
       (row - 2 >= 0 and board[row - 2][col + 2] == player)):
      if col + 3 < 10 and \
         (board[row][col + 3] == player or \
         (row + 3 < 10 and board[row + 3][col + 3] == player) or \
         (row - 3 >= 0 and board[row - 3][col + 3] == player)):
        if col + 4 < 10 and \
           (board[row][col + 4] == player or \
           (row + 4 < 10 and board[row + 4][col + 4] == player) or \
           (row - 4 >= 0 and board[row - 4][col + 4] == player)):
           potentialWins += 10000
        elif col + 4 < 10 and \
             (board[row][col + 4] == 0 or \
             (row + 4 < 10 and board[row + 4][col + 4] == 0) or \
             (row - 4 >= 0 and board[row - 4][col + 4] == 0)):
          potentialWins += 1000
      elif col + 3 < 10 and \
           (board[row][col + 3] == 0 or \
           (row + 3 < 10 and board[row + 3][col + 3] == 0) or \
           (row - 3 >= 0 and board[row - 3][col + 3] == 0)):
        potentialWins += 100
    elif col + 2 < 10 and \
         (board[row][col + 2] == 0 or \
         (row + 2 < 10  and board[row + 2][col + 2] == 0) or \
         (row - 2 >= 0 and board[row - 2][col + 2] == 0)):
      potentialWins += 10
  ...
  if row + 1 < 10 and board[row + 1][col] == player:
    if row + 2 < 10 and board[row + 2][col] == player:
      if row + 3 < 10 and board[row + 3][col] == player:
        if (row + 4 < 10 and board[row + 4][col] == player):
          potentialWins += 10000
        elif (row + 4 < 10 and board[row + 4][col] == 0):
          potentialWins += 1000
      elif row + 3 < 10 and board[row + 3][col] == 0:
        potentialWins += 100
    elif row + 2 < 10 and board[row + 2][col] == 0:
      potentialWins += 10

  if row - 1 >= 0 and board[row - 1][col] == player:
    if row - 2 >= 0 and board[row - 2][col] == player:
      if row - 3 >= 0 and board[row - 3][col] == player:
        if (row - 4 >= 0 and board[row - 4][col] == player):
          potentialWins += 10000
        elif (row - 4 >= 0 and board[row - 4][col] == player):
          potentialWins += 1000
      elif row - 3 >= 0 and board[row - 3][col] == player:
        potentialWins += 100
    elif row - 2 >= 0 and board[row - 2][col] == player:
      potentialWins += 10

  return potentialWins*10 + HEURISTIC_VALUES[row*10 + col]
...
#     for col in range(10):
#       if player == 1:
#         h += getPotentialWins(board, (row, col), 1)
#         h -= getPotentialWins(board, (row, col), 2)
#       else:
#         h -= getPotentialWins(board, (row, col), 1)
#         h += getPotentialWins(board, (row, col), 2)
#   return h
